...
type NegativeKind = "401" | "404" | "400" | "409" | "422";
type InspectorData = {
  method: string;
  url: string;
...
export function LearningToolsStyles() {
  return <style>{`
    .feedback-fab{position:fixed;right:22px;bottom:22px;z-index:30;padding:12px 16px;border-radius:30px;background:#167d74;color:#fff;text-decoration:none;font-size:11px;font-weight:800;box-shadow:0 12px 32px #10243e3d}.feedback-fab:hover{transform:translateY(-2px)}
    ...
    .mode-switcher,.practice-data-bar,.negative-lab,.request-inspector,.challenge-board,.postman-guide{width:min(1200px,calc(100% - 48px));margin:30px auto;padding:28px;border:1px solid #d9e2ea;border-radius:16px;background:#fff;box-shadow:0 14px 40px #10243e0b}.mode-switcher,.practice-data-bar,.tool-heading{display:flex;justify-content:space-between;align-items:center;gap:22px}.mode-switcher>div:first-child{display:flex;align-items:center;gap:13px}.mode-switcher p,.practice-data-bar p,.tool-heading p,.negative-lab p,.challenge-board p,.postman-guide p{margin:5px 0;color:#64748b;font-size:11px;line-height:1.6}.mode-icon{display:grid;place-items:center;width:40px;height:40px;border-radius:11px;background:#dff5f0;color:#11776e;font-size:21px}.mode-options{display:flex;padding:4px;border-radius:10px;background:#eef2f6}.mode-options button{min-width:135px;padding:9px 13px;border:0;border-radius:7px;background:transparent;color:#65768a;text-align:left}.mode-options button b,.mode-options button span{display:block}.mode-options button b{font-size:11px}.mode-options button span{font-size:9px}.mode-options button.active{background:#10243e;color:#fff}.mode-free .beginner-section,.mode-free .banking-flow-guide{display:none}
